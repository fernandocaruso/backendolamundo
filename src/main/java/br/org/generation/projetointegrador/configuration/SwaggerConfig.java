...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("Projeto Ola Mundo")
			.description("Projeto API Spring - Ola Mundo")
			.version("1.0.0")
	...
	private static Contact contact() {
		...
		return new Contact("AdminsOlaMundo", "https://github.com/olamundoprojeto", "olamundoprojeto@gmail.com");
